        ...
        <div class="container text-center text-md-start mt-5 mb-4">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-lg-3 col-sm-12">
                    ...
                    <p class="mt-3">© 2023 Copyright: MDBootstrap.com.</p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-12 col-sm-12 col-lg-3">
                    ...
                    <a href="#" class="mb-2 d-inline-block">
                        <img src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/misc/btn-appstore.webp" height="38" /></a>
                    <a href="#" class="mb-2 d-inline-block">
                        <img src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/misc/btn-market.webp" height="38" /></a>
                </div>
                <!-- Grid column -->
            </div>
            <!-- Grid row -->
        ...
        <div class="py-4 border-top">
            <div class="d-flex justify-content-between">
                ...
                <div class="dropdown dropup">
                    <a class="dropdown-toggle text-dark" href="#" id="Dropdown" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
