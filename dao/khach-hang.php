...
function khach_hang_update_khong_hinh($ma_kh, $mat_khau, $ho_ten, $email, $kich_hoat, $vai_tro)
{
    $sql = "UPDATE khach_hang SET mat_khau=?,ho_ten=?,email=?,kich_hoat=?,vai_tro=? WHERE ma_kh=?";
    pdo_execute($sql, $mat_khau, $ho_ten, $email, $kich_hoat == 1, $vai_tro == 1, $ma_kh);
}
